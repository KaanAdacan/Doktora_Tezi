...
ROOT = Path('/home/kaan/NAMD/systems/ADK/NVT_NPT_GPU')
PSF = ROOT / 'inputs/ADK_ion.psf'
NPT_COOR = ROOT / 'runs/02_NPT/ADK_NPT.coor'
NPT_XSC = ROOT / 'runs/02_NPT/ADK_NPT.xsc'
DCDS = [ROOT / 'runs/03_PROD_000_025ns/ADK_PROD_000_025ns.dcd',
    ROOT / 'runs/04_PROD_025_050ns/ADK_PROD_025_050ns.dcd',
    ROOT / 'runs/05_PROD_050_075ns/ADK_PROD_050_075ns.dcd',
    ROOT / 'runs/06_PROD_075_100ns/ADK_PROD_075_100ns.dcd']
EXPECTED_ATOMS = 167433
EXPECTED_SEGMENT_FRAMES = [12500, 12500, 12500, 12500]
EXPECTED_TOTAL_FRAMES = 50000
RAW_FRAME_PS = 2.0
SAMPLE_INDICES = range(4, 50000, 5)
SYSTEM = 'ADK'
